...
! function ($) {
    ...
    var getColumn = function (columns, field) {
    ...
    BootstrapTable.prototype.initHeader = function () {
        ...
        $.each(this.options.columns, function (i, columns) {
            html.push('<tr>');
            $.each($.isArray(columns) ? columns : [columns], function (j, column) {
                var text = '',
        ...
        if (this.options.sidePagination !== 'server') {
            ...
            this.data = s ? $.grep(this.data, function (item, i) {
                for (var key in item) {
                    ...
                    var value = item[key],
                        column = getColumn(that.options.columns, key),
        ...
        for (var i = this.pageFrom - 1; i < this.pageTo; i++) {
            ...
            $.each(this.header.fields, function (j, field) {
                var text = '',
                    ...
                    rowspan_ = '',
                    title_ = '',
                    column = getColumn(that.options.columns, field);
